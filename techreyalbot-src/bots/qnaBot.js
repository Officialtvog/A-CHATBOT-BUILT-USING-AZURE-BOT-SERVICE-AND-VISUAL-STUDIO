        ...
        this.onMembersAdded(async (context, next) => {
            ...
            for (let cnt = 0; cnt < membersAdded.length; cnt++) {
                if (membersAdded[cnt].id !== context.activity.recipient.id) {
                    await context.sendActivity('Welcome to TECH REYAL!!!.The home of software developmnt and data analytics,i am tech reyals bot,please you can ask me any questions as regards tech reyal,i will do my best to answer...');
                }
            }
